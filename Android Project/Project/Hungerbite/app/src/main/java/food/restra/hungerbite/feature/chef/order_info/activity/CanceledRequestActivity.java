...
public class CanceledRequestActivity extends AppCompatActivity implements CanceledRequestAdapter.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_canceled_request);
        gson = new Gson();
