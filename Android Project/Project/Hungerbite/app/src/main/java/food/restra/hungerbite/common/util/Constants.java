package food.restra.hungerbite.common.util;
...
public class Constants {
    ...
    public static final String NEW_REQUST_DATA = "NEW_REQUST_DATA";
    ...
    public static final String USER_DATA = "EDIT_ITEM_DATA";
